/**
 * Particle → Spine Exporter v100 (Alpha) - Main Component
 *
 * Version: 100
 * Date: 2025-11-27
 *
 * Changes in v100:
 * - Burst and Duration exports now bake animations with burst_#/duration_# names when looping is off
 * - Default Burst Count set to 10 and Color Threshold lowered to 60 for clearer captures
 * - Inherits v99 improvements (per-emitter sprites, visibility fixes, prewarm seam correction)
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white p-6">
      <div className="max-w-[1870px] mx-auto">
        <header className="mb-4">
          ...
          <p className="text-xs text-slate-400">Burst/Duration export keys • Lowered color threshold defaults • Per-emitter sprite atlases</p>
        </header>
