/**
 * Particle → Spine Exporter v92 (Alpha)
 *
 * Version: 92
 * Date: 2025-11-25
 *
 * Major Changes in v92:
 * - Fixed prewarm animation to only append loop data to existing bones/slots
 * - Prevents creation of duplicate bones in JSON export
 * - Only particles that exist in both prewarm and loop will have their loop data appended
 */
