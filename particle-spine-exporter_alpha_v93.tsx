/**
 * Particle → Spine Exporter v93 (Alpha)
 *
 * Version: 93
 * Date: 2025-11-25
 *
 * Major Changes in v93:
 * - Fixed bone collection to only create bones for particles in loop animation
 * - Removed collection of particle IDs from prewarm frames
 * - This ensures only the actual loop particles get bones in the skeleton
 * - Fixes issue where 52 bones were created instead of expected 20
 */
