 ...
 * - Fixed duplicate timeline placement and improved numeric input flexibility
 * - Added vortex force visualization toggle with directional arrows
 * - Improved custom sprite loading reliability and independent axis scaling
 */
