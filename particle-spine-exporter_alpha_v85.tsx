 ...
 * - UI layout updated: emitter settings moved beneath the viewport column
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white p-4">
      <div className="max-w-6xl mx-auto">
        <header className="mb-4">
          ...
          <p className="text-xs text-slate-400">Emitter controls beneath the viewport • Dedicated export column • Lifetime curves and gradients stretched to full width</p>
        </header>
