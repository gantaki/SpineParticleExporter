/**
 * Particle → Spine Exporter v95 (Alpha)
 *
 * Version: 95
 * Date: 2025-11-25
 *
 * Major Changes in v95:
 * - Added bone count limitation based on rate × duration for Loop+Prewarm mode
 * - When both looping and prewarm are enabled, limits bones to rate × duration
 * - Only keeps bones with IDs from 0 to (rate × duration - 1)
 * - Ensures clean looping animations without excess bones
 */
