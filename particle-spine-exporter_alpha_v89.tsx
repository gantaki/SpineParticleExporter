 ...
 * - Noise field reworked for sharper, jerky turbulence with higher-frequency defaults
 * - Multiplier graphs auto-fit points with a default -1 to 1 range and responsive width updates
 * - Speed controls relocated to particle settings, gravity defaults to zero, and Random Spin removed
 * - Color Over Lifetime slider stretches full width and auto-opens the color picker on interaction
 */
