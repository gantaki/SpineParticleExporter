/**
 * Particle → Spine Exporter v84c (Alpha)
 *
 * Version: 84c
 * Date: 2025-11-23
 *
 * Major Changes in v84c:
 * - Simplified exports to JSON-only for leaner bundles
 * - Updated Spine metadata string for 4.2-from-4.3.39-beta compatibility
 * - UI panels default to collapsed (except emitter) to reduce clutter
 *
...
function generateSpineJSON(frames: BakedFrame[], prewarmFrames: BakedFrame[], settings: ParticleSettings): string {
  ...
  const skeleton: any = { hash: "particle_export", spine: "4.2-from-4.3.39-beta", x: 0, y: 0 };
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-4">
          <h1 className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            Particle → Spine Exporter v84c
          </h1>
          <p className="text-xs text-slate-400">Spine 4.2-from-4.3.39-beta JSON • Prewarm animation included</p>
        </header>
