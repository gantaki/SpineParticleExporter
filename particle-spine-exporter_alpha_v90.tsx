/**
 * Particle → Spine Exporter v90 (Alpha)
 *
 * Version: 90
 * Date: 2025-11-25
 *
 * Major Changes in v90:
 * - Fixed crashes when resetting graphs or all settings with >3 curve points
 * - Added dashed zero-value line indicator on curve graphs
 * - Reduced Color Over Lifetime slider width to prevent overflow
 * - Fixed graph expansion animation when opening collapsible sections
 * - Added viewport grid toggle with 50px grid step
 * - Changed Spine JSON export: slots now use 'rgba' parameter instead of 'color' (Spine 4.0+ compatibility)
 */
