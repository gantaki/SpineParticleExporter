/**
 * Particle → Spine Exporter v83 (Alpha)
 *
 * Version: 83
 * Date: 2025-11-23
 *
 * Major Changes in v83:
 * - Reduced exported key clutter by raising default thresholds
 * - Direction-aware keying: skip keys while movement/rotation stays in one direction
 * - Added export settings to tune direction change sensitivity and thresholds
 *
