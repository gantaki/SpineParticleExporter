/**
 * Particle → Spine Exporter v88 (Alpha)
 *
 * Version: 88
 * Date: 2026-06-09
 *
 * Major Changes in v88:
 * - Timeline docked into the viewport card for a single, cohesive play area
 * - Force and curve parameters now support random ranges with normalized curve multipliers
 * - Manual curve inputs accept free-form text with vortex arrows hidden by default
 */
...
const DEFAULT_SETTINGS: ParticleSettings = {
  ...
  noiseFrequencyRange: { min: 0.01, max: 0.01 },
  noiseSpeedRange: { min: 1.0, max: 1.0 },
