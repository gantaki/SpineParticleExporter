 ...
 *   node serve-standalone.js v101      # serve v101 on port 3000
...
const defaultVersion = normalizeVersion(args.find(arg => !/^\d+$/.test(arg)) || 'v101');
...
server.listen(PORT, () => {
  ...
  console.log('   Use ?version=v96|v97|v98|v99|v100|v101 to swap builds per request.');
