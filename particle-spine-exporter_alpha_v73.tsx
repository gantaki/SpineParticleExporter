    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white p-4">
      <div className="max-w-6xl mx-auto">
        <header className="mb-4">
          ...
          <p className="text-xs text-slate-400">Interactive curve-based particle system</p>
        </header>
          ...
          <div className="space-y-2 max-w-md">
            ...
            <CollapsibleSection title="📈 Curves Over Lifetime" isOpen={curvesOpen} onToggle={() => setCurvesOpen(!curvesOpen)}>
              <div className="space-y-2">
                ...
                <CurveEditor label="Spin" curve={settings.spinOverLifetime} onChange={curve => updateSettings({ ...settings, spinOverLifetime: curve })} min={-360} max={360} />
