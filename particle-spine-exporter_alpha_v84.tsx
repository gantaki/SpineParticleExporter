/**
 * Particle → Spine Exporter v84 (Alpha)
 *
 * Version: 84
 * Date: 2025-11-23
 *
 * Major Changes in v84:
 * - Spine JSON updated for 4.2+ compatibility while remaining portable across 3.8–4.3
 * - Added dedicated "prewarm" animation capturing the full warmup cycle
 * - Documented version bump in UI header for clarity
 *
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-4">
          <h1 className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            Particle → Spine Exporter v84
          </h1>
          <p className="text-xs text-slate-400">Spine 4.2 compatible JSON • Separate prewarm animation • Direction-aware key reduction</p>
        </header>
